function startTimer() {
  (Timer = setInterval(function () {
    $("#box_nextBtn").click();
  }, 10000)), /* TIEMPO DE NEXT SLIDER */
  $("[id^=MinSinopFila]").slideUp("fast");
}
...
function stopTimer() {
      ...
      this.each(function () {
        ...
        if (!l.data("cycle.opts")) {
          ...
          for (var a in n)
            ...
            /^cycle[A-Z]+/.test(a) &&
            ((r = n[a]),
              (s = a.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, t)),
              c(s + ":", r, "(" + typeof r + ")"),
              (n[s] = r));
          ((o = e.extend({}, e.fn.cycle.defaults, n, i || {})).timeoutId = 0),
          (o.paused = o.paused || !1),
          (o.container = l),
          (o._maxZ = o.maxZ),
          (o.API = e.extend({
          ...
          (o.API.log = c),
          (o.API.trigger = function (e, t) {
            return o.container.trigger(e, t), o.API;
          }),
          l.data("cycle.opts", o),
            l.data("cycle.API", o.API),
  ...
  (e.fn.cycle.API = {
    ...
    initSlideshow: function () {
      ...
      i.API.calcFirstSlide(),
        ...
        i.timeout &&
        ((t = i.API.getSlideOpts(i.currSlide)),
      ...
      t ? (i.hoverPaused = !0) : (i.paused = !0),
        ...
        (i.container.addClass("cycle-paused"),
          ...
          (clearTimeout(i.timeoutId),
            ...
            (i._remainingTimeout < 0 || isNaN(i._remainingTimeout)) &&
      ...
      "string" == e.type(t) && (t = e.trim(t)),
        e(t).each(function () {
          ...
          i ? o.container.prepend(n) : o.container.append(n),
            o.slideCount++,
            (t = o.API.buildSlideOpts(n)),
            (o.slides = i ? e(n).add(o.slides) : o.slides.add(n)),
            o.API.initSlide(t, n, --o._maxZ),
            n.data("cycle.opts", t),
            o.API.trigger("cycle-slide-added", [o, t, n]);
        }),
        o.API.updateView(!0),
        o._preInitialized &&
        2 > s &&
    ...
    calcTx: function (t, i) {
      ...
      return (
        o._tempFx ?
        (n = e.fn.cycle.transitions[o._tempFx]) :
        i && o.manualFx && (n = e.fn.cycle.transitions[o.manualFx]),
        n || (n = e.fn.cycle.transitions[o.fx]),
        (o._tempFx = null),
        (this.opts()._tempFx = null),
        n ||
        ((n = e.fn.cycle.transitions.fade),
          o.API.log('Transition "' + o.fx + '" not found.  Using fade.')),
        n
      );
    },
          ...
          void(
            ...
            ((0 !== l.timeoutId || e) &&
              ((n = l.slides[l.currSlide]),
                (o = l.slides[l.nextSlide]),
                (s = l.API.getSlideOpts(l.nextSlide)),
                (r = l.API.calcTx(s, e)),
                (l._tx = r),
                e && void 0 !== s.manualSpeed && (s.speed = s.manualSpeed),
                l.nextSlide != l.currSlide &&
                (e || (!l.paused && !l.hoverPaused && l.timeout)) ?
                (l.API.trigger("cycle-before", [s, n, o, t]),
                  r.before && r.before(s, n, o, t),
                  (i = function () {
                    (l.busy = !1),
                    l.container.data("cycle.opts") &&
                      (r.after && r.after(s, n, o, t),
                        l.API.trigger("cycle-after", [s, n, o, t]),
                        l.API.queueTransition(s),
                        l.API.updateView(!0));
                  }),
                  (l.busy = !0),
                  r.transition ?
                  r.transition(s, n, o, t, i) :
                  l.API.doTransition(s, n, o, t, i),
                  l.API.calcNextSlide(),
                  l.API.updateView()) :
                l.API.queueTransition(s)))
          ));
    ...
    queueTransition: function (t, i) {
      ...
      return 0 === n.nextSlide && 0 == --n.loop ?
        ...
        (!1 === n.continueAuto ||
          (e.isFunction(n.continueAuto) && !1 === n.continueAuto())) ?
    ...
    buildSlideOpts: function (i) {
      ...
      for (var l in r)
        ...
        /^cycle[A-Z]+/.test(l) &&
        ((n = r[l]),
          (o = l.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, t)),
          s.API.log(
            "[" + (s.slideCount - 1) + "]",
            o + ":",
            n,
          ...
          (r[o] = n));
      (r = e.extend({}, e.fn.cycle.defaults, s, r)).slideNum = s.slideCount;
      try {
        delete r.API,
          delete r.slideCount,
          delete r.currSlide,
    ...
    updateView: function (e, t) {
      ...
      if (i._initialized) {
        ...
        (!e &&
          !0 !== t &&
          (i.API.trigger("cycle-update-view-before", [i, n, o]),
            i.updateView < 0)) ||
        (i.slideActiveClass &&
          i.slides
          ...
          0 !== i.updateView &&
          i.API.trigger("cycle-update-view", [i, n, o, e]),
          e && i.API.trigger("cycle-update-view-after", [i, n, o]));
      }
    },
    ...
    stackSlides: function (t, i, n) {
      var o = this.opts();
      t ||
        ((t = o.slides[o.currSlide]),
          (i = o.slides[o.nextSlide]),
          (n = !o.reverse)),
        e(t).css("zIndex", o.maxZ);
      var s,
        r = o.maxZ - 2,
        l = o.slideCount;
      if (n) {
        for (s = o.currSlide + 1; l > s; s++)
          e(o.slides[s]).css("zIndex", r--);
        for (s = 0; s < o.currSlide; s++) e(o.slides[s]).css("zIndex", r--);
      } else {
        for (s = o.currSlide - 1; s >= 0; s--)
          e(o.slides[s]).css("zIndex", r--);
        for (s = l - 1; s > o.currSlide; s--)
          e(o.slides[s]).css("zIndex", r--);
      }
  ...
  (e.fn.cycle.log = function () {
    window.console &&
      console.log &&
      console.log("[Ciclo] " + Array.prototype.join.call(arguments, " "));
  }),
...
(function (e) {
  ...
  function t(t, i) {
    var n,
      ...
      r = i.autoHeight;
    if ("container" == r)
      (o = e(i.slides[i.currSlide]).outerHeight()), i.container.height(o);
  ...
  function n(o, s) {
    s._autoHeightOnResize &&
      ...
      s.container.off("cycle-destroyed", n),
      s.container.off("cycle-before", i),
  ...
  e.extend(e.fn.cycle.defaults, {
    ...
    e(document).on("cycle-initialized", function (o, s) {
      function r() {
        t(0, s);
      }
      var l,
      ...
      (s.container.on("cycle-slide-added cycle-slide-removed", t),
        s.container.on("cycle-destroyed", n),
        "container" == c ?
        s.container.on("cycle-before", i) :
        "string" === a &&
        /\d+\:\d+/.test(c) &&
        ((l = c.match(/(\d+)\:(\d+)/)),
          (l = l[1] / l[2]),
          (s._autoHeightRatio = l)),
        "number" !== a &&
  ...
  e.extend(e.fn.cycle.defaults, {
    ...
    e(document).on("cycle-update-view", function (t, i, n, o) {
      "caption" === i.captionModule &&
        e.each(["caption", "overlay"], function () {
          ...
          t.length && e ?
            (t.html(i.API.tmpl(e, n, i, o)), t.show()) :
            t.hide();
        });
    }),
    e(document).on("cycle-destroyed", function (t, i) {
      ...
      e.each(["caption", "overlay"], function () {
        ...
        i[this] && e && (n = i.API.getComponent("caption")).empty();
      });
    });
})(jQuery),
(function (e) {
  ...
  (e.fn.cycle = function (i) {
    ...
    return "number" == e.type(i) ?
      ...
      this.each(function () {
        ...
        return (
          (n = i),
          void 0 === (s = e(this).data("cycle.opts")) ?
          void t.log(
          ...
          ((n = "goto" == n ? "jump" : n),
            (o = s.API[n]),
            e.isFunction(o) ?
            ((l = e.makeArray(r)).shift(), o.apply(s.API, l)) :
    ...
    e.extend(t.API, {
      next: function () {
        ...
        if (!e.busy || e.manualTrump) {
          ...
          (e.API.advanceSlide(t),
            e.API.trigger("Ciclo Siguiente", [e]).log("Ciclo Siguiente"));
        }
      },
      prev: function () {
        var e = this.opts();
        if (!e.busy || e.manualTrump) {
          ...
          (e.API.advanceSlide(t),
            e.API.trigger("Ciclo Anterior", [e]).log("Ciclo Anterior"));
        }
      },
      destroy: function () {
        this.stop();
      ...
      jump: function (e, t) {
        ...
        if (!n.busy || n.manualTrump) {
          var o = parseInt(e, 10);
          if (isNaN(o) || 0 > o || o >= n.slides.length)
            return void n.API.log("goto: invalid slide index: " + o);
          if (o == n.currSlide)
            return void n.API.log("goto: skipping, already on slide", o);
          (n.nextSlide = o),
          clearTimeout(n.timeoutId),
            (n.timeoutId = 0),
            n.API.log("goto: ", o, " (zero-index)"),
      ...
      stop: function () {
        ...
        clearTimeout(t.timeoutId),
          ...
          t.pauseOnHover &&
          (!0 !== t.pauseOnHover && (i = e(t.pauseOnHover)),
      ...
      remove: function (t) {
        for (
          var i, n, o = this.opts(), s = [], r = 1, l = 0; l < o.slides.length; l++
        )
          (i = o.slides[l]),
          l == t ?
          (n = i) :
          (s.push(i), (e(i).data("cycle.opts").slideNum = r), r++);
        n &&
          ((o.slides = e(s)),
            o.slideCount--,
            e(n).remove(),
            ...
            :
            o.currSlide++,
            o.API.trigger("cycle-slide-removed", [o, t, n]).log(
              "cycle-slide-removed"
            ),
            o.API.updateView());
      },
  ...
  function t(t, i) {
    ...
    return t._hashFence ?
      ...
      ((n = window.location.hash.substring(1)),
        void t.slides.each(function (o) {
          if (e(this).data("cycle-hash") == n) {
            if (!0 === i) t.startingSlide = o;
            else {
              var s = t.currSlide < o;
        ...
        ((n = i.API.add),
          (i.API.add = function (t, o) {
            ...
            if ("string" == e.type(t)) t = e.trim(t);
              ...
              for (var c = 0; c < t.length; c++) t[c] = e(t[c])[0];
            var a = (t = e(t)).length;
            a &&
              (t
                .css("visibility", "hidden")
      ...
      if (i.progressive) {
        ...
        if ("array" == a) n = i.progressive;
          ...
          if (/^(\[)/.test(n))
            ...
            (n = n.split(new RegExp(o.data("cycle-split") || "\n")))[
              n.length - 1
            ] || n.pop();
        }
        c &&
          (s.prepareTx = function (e, t) {
            var o, s;
            return e || 0 === n.length ?
              void c.apply(i.API, [e, t]) :
        ...
        return (
          ...
          t.replace(n, function (t, i) {
            ...
            for (n = 0; n < o.length; n++)
              if ((r = o[n])) {
                if (c.length > 1)
                  for (l = r, s = 0; s < c.length; s++)
                    (r = l), (l = l[c[s]] || i);
                else l = r[i];
                if (e.isFunction(l)) return l.apply(r, o);
...
$("#slider").hide(),
  ...
  startTimer(),
  $("#box_prevBtn").click(function (e) {
    stopTimer(), startTimer();
  }),
  $("#box_nextBtn").click(function (e) {
    stopTimer(), startTimer();
  }),
  ...
  $(".img-responsive").click(function (e) {
    (prog = e.target.id),
    (titu = e.target.alt),
    (tLink = $(this).attr("tLink")),
    (actualprog = ""),
    0 == tLink && "housenumber" != prog ?
      "http://" == prog.substring(0, 7) ||
      "https://" == prog.substring(0, 8) ?
      window.open(prog) :
      (location.href = prog) :
      (location.href = "movie/" + prog + "/" + titu);
  }),

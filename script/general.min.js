...
function getCookie(t) {
  for (
    var e = t + "=", n = document.cookie.split(";"), i = 0; i < n.length; i++
  ) {
    for (var o = n[i];
...
if (
  ((function (t, e) {
      ...
      function O(t, e, n) {
        for (
          var i, o = (de[e] || []).concat(de["*"]), r = 0, s = o.length; s > r; r++
        )
      ...
      var it = (function (t) {
        ...
        function c(t) {
          return i(function (e) {
            return (
              ...
              i(function (n, i) {
                for (
                  var o, r = t([], n.length, e), s = r.length; s--;
        ...
        function g(t, e, n, i, o) {
          for (
            var r, s = [], a = 0, l = t.length, c = null != e; l > a; a++
          )
            (r = t[a]) &&
            (!n || n(r, i, o)) &&
            (s.push(r), c && e.push(a));
        ...
        return (
          ...
          (S = e.select = function (t, e, n, i) {
            ...
            if (((n = n || []), 1 === d.length)) {
              ...
              for (
                o = ht.needsContext.test(t) ? 0 : r.length; o-- && ((s = r[o]), !w.relative[(a = s.type)]);
      ...
      (function () {
        ...
        for (e in {
          ...
          (J[e + "Bubbles"] = n in t) ||
          (i.setAttribute(n, "t"),
            (J[e + "Bubbles"] = !1 === i.attributes[n].expando));
        i = null;
      })();
        ...
        trigger: function (e, n, i, o) {
          ...
          if (
            ...
            if (!o && !c.noBubble && !G.isWindow(i)) {
              for (
                l = c.delegateType || h,
                $t.test(l + h) || (a = a.parentNode); a; a = a.parentNode
              )
                p.push(a), (u = a);
      ...
      G.extend({
          clone: function (t, e, n) {
            ...
            if (e)
              if (n)
                for (
                  a = a || g(t), i = i || g(r), s = 0; null != (o = a[s]); s++
                )
                  w(o, i[s]);
              else w(t, r);
            return (
          ...
          cleanData: function (t, e) {
            for (
              var n,
                ...
                l = G.cache,
                c = J.deleteExpando,
                u = G.event.special; null != (n = t[s]); s++
            )
              if (
                (e || G.acceptData(n)) &&
                ((o = n[a]), (r = o && l[o]))
        ...
        G.fn.extend({
          ...
          remove: function (t, e) {
            for (
              var n, i = t ? G.filter(t, this) : this, o = 0; null != (n = i[o]); o++
            )
          ...
          empty: function () {
            for (var t, e = 0; null != (t = this[e]); e++) {
              for (
                1 === t.nodeType && G.cleanData(g(t, !1)); t.firstChild;
          ...
          domManip: function (t, e) {
            ...
            if (
              ...
              for (
                o = (r = G.map(g(a, "script"), y)).length; c > l; l++
              )
                (i = a),
                l !== d &&
                ((i = G.clone(i, !0, !0)),
        ...
        G.each({
          ...
          function (t, e) {
            G.fn[t] = function (t) {
              for (
                var n, i = 0, o = [], r = G(t), s = r.length - 1; s >= i; i++
              )
          ...
          (G.cssHooks[t + e] = {
            expand: function (n) {
              for (
                var i = 0,
                  o = {},
                  r = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++
              )
...
(function (t) {
  ...
  (e.prototype.init = function (e, n, i) {
    ...
    for (
      var o = this.options.trigger.split(" "), r = o.length; r--;
  ...
  (e.prototype.setContent = function () {
    var t = this.tip(),
      e = this.getTitle();
    t
      .find(".tooltip-inner")[this.options.html ? "html" : "text"](e),
...
(function (t) {
  ...
  (e.prototype.setContent = function () {
    var t = this.tip(),
      ...
      n = this.getContent();
    t
      .find(".popover-title")[this.options.html ? "html" : "text"](e),
      t
...
$("#searchD").keypress(function (t) {
  ...
  $("#searchD").autocomplete({
    serviceUrl: "/ajax.predictiva.html?c="
  });
